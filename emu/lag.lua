...
-- SWCHA/SWCHB/INPT4/INPT5 in the whole run come from TNSHIM, and the game's own
-- seven sites are gone. This answers it dynamically, which is the half a human
-- can see: a build with TNLAG=1 refreshes the shadows once every 64 frames, so
