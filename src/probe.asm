...
; step took into TNFCNT. emu/latency.lua taps those two cells against a VSYNC
...
TNFCNT  EQU     $FA             ; video frames the current transaction has taken
...
;
; TNFCNT counts the frames this transaction took, and is what M1 is for.
PGO:    lda     FNACKS
        clc
        adc     #1
        bne     PGO1
