#!/usr/bin/env python3
"""tennis_client_sim.py -- two simulated consoles against a fresh relay.
...
Usage: tennis_client_sim.py [--port 9639]
"""
...
def relay_argv():
    ...
    server/tennis_relay_server.py stays the canonical reference
    ...
    if impl == "py":
        return [sys.executable, os.path.join(HERE, "server/tennis_relay_server.py")]
    if impl == "c":
        binary = os.path.join(HERE, "server/c/tennis-relay")
