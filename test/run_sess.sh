...
PLAYER=PLAYER1 ENDPOINT="TCP://127.0.0.1:$RELAY_PORT/" ./build.sh tennis >/dev/null 2>&1
cp build/tennis.bin build/vo1.bin
...
setsid python3 server/tennis_relay_server.py --host 127.0.0.1 --port "$RELAY_PORT" \
